...
select email,income as "salários mínimos"
...
select email,income, 
(income <= '4800') as "abaixo de 4 salarios",
(income >= '4800') as "acima de 4 salarios"     --resolução 1
from sales.customers


select email,income,
	(income) / 1200 as "salários mínimos",
	((income) / 1200) > 4 as "acima de 4 salários"  --resolução 2
from sales.customers
...
select email,income,
(income <= '4800') as "abaixo de 4 salarios",
(income >= '4800') as "acima de 4 salarios"
from sales.customers 
